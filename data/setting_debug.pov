...
#include "colors.inc"  
#include "shapes.inc"
#include "/home/haoyuan/rendering/data/shape_1.inc"
#include "/home/haoyuan/rendering/data/shape_2.inc"
#include "/home/haoyuan/rendering/data/shape_3.inc"
#include "/home/haoyuan/rendering/data/shape_4.inc"
#include "/home/haoyuan/rendering/data/shape_5.inc"
...
#macro OrientZ(p1,p2,cs)
    ...
    #declare pigmentStructure = pigment {
        ...
        #else
            image_map { png concat("data/COCO_train2014_000000000009.jpg", str(clock-2,1,0), ".png") map_type 0 interpolate 2 }
        #end
    }
#else
    #declare pigmentImage = pigment {
            ...
            color Black
        #else
            #ifdef (rho) color White #else image_map { jpeg "data/COCO_train2014_000000000009.jpg" map_type 0 interpolate 2 } #end
        #end
    }
#end
...
object {
    cone {
        ...
        <0, -1, 0>, 1.0    // Center and radius of other end
